<template>
	<view>
		<view class="status-bar">
			<!--自定义navbar-->
			<uni-nav-bar title="随机练习" background-color="#00aaff" color="#FFFFFF" status-bar="true">
				<block slot="left">
			...
			uni.request({
				...
				success: (res1) => {
					...
					if (res1.statusCode == 200) {
						this.problem_id_list = this.shuffle(res1.data.problems)
...
<style lang="scss">
	@import url('@/pages/problemExam/problem_exam.scss');
</style>
