<template>
	<view class="container">
		<view class="title_wrapper">
			<textarea class="title" :placeholder="title_placeholder" :maxlength="title_maxlength"
		...
		<view class="page-body">
			<view class='wrapper'>
				...
				<view class="editor-wrapper">
					<editor id="editor" class="ql-container" :placeholder="content_placeholder" showImgSize
